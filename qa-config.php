...
*/
        ...
        define('QA_MYSQL_HOSTNAME', 'edjo.usask.ca'); // try '127.0.0.1' or 'localhost' if MySQL on same server
        define('QA_MYSQL_USERNAME', 'cmpt412gr01');
        define('QA_MYSQL_PASSWORD', 'c8h2np4a');
        define('QA_MYSQL_DATABASE', 'cmpt412gr01');	
/*
